...
void uac1_PCM1792A_task(void*);

//!
//! @brief This function initializes the hardware/software resources
//! required for device CDC task.
//!
void uac1_PCM1792A_task_init(void) {
	PCM1792A_task_init(TRUE);
	xTaskCreate(uac1_PCM1792A_task,
				configTSK_PCM1792A_NAME,
				configTSK_PCM1792A_STACK_SIZE,
				NULL,
				UAC1_configTSK_PCM1792A_PRIORITY,
				NULL);
}
...
//!
void uac1_PCM1792A_task(void *pvParameters) {
	...
	while (TRUE) {
		...
		vTaskDelayUntil(&xLastWakeTime, UAC1_configTSK_PCM1792A_PERIOD);
