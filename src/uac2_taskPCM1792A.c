...
void uac2_PCM1792A_task(void*);

//!
//! @brief This function initializes the hardware/software resources
//! required for device CDC task.
//!
void uac2_PCM1792A_task_init(void) {
...
//clear samplerate indication FIX: move to different _init() routine
	...
	xTaskCreate(uac2_PCM1792A_task,
				configTSK_PCM1792A_NAME,
				configTSK_PCM1792A_STACK_SIZE,
				NULL,
				UAC2_configTSK_PCM1792A_PRIORITY,
				NULL);
}

//!
//! @brief Entry point of the PCM1792A task management
//!
void uac2_PCM1792A_task(void *pvParameters) {
...
/*
	...
	U32 sampling_rate = 48*(UAC2_configTSK_PCM1792A_PERIOD/10)*NUM_INTERVAL;
	U32 old_sampling_rate = 48*(UAC2_configTSK_PCM1792A_PERIOD/10)*NUM_INTERVAL;
...
*/
	while (TRUE) {
		...
		vTaskDelayUntil(&xLastWakeTime, UAC2_configTSK_PCM1792A_PERIOD);
